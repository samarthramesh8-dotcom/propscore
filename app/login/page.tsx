...
export default function LoginPage() {
  ...
  async function handleGoogleSignIn() {
    ...
    // On success the browser is redirected — no further state update needed.
  }
      ...
      <div className="psl-rp">
        ...
        <div className={`psl-form-wrap${mounted ? " psl-form-in" : ""}`}>
          ...
          <button
            ...
            className="psl-google-btn"
          >
            {oauthLoading ? (
              <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" viewBox="0 0 24 24" className="psl-spin">
